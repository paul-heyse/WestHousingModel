...
STATIC_NAME = "usgs_epqs"
SOURCE_ID = "connector.usgs_epqs"


@dataclass(slots=True)
class USGSEPQSConfig:
...
def _load_static() -> pd.DataFrame:
    ...
    frame["slope_gt15_pct_within_10km"] = frame["slope_gt15_pct_within_10km"].astype(float)
    return frame
...
def fetch_usgs_epqs(
    *,
    ...
    return normalized[["place_id", "slope_gt15_pct_within_10km", "observed_at", "source_id"]]


__all__ = ["fetch_usgs_epqs", "USGSEPQSConfig"]
