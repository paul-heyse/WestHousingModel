...
1. Create `changes/[change-id]/` (kebab-case, verb-led, unique).
2. Draft `proposal.md`:
...
3. Create spec deltas in `specs/[capability]/spec.md`. Each requirement must follow the scenario format in the guidance above.
4. Author `tasks.md` with checked-in checklist items:
...
5. Add `design.md` when the change spans modules, introduces dependencies, or needs architectural decisions. Use this template:
